...
<body class="text-center">
    ...
    <main class="form-signin">
            <form action="regin_vod.php" method="POST" class="post-form">
                ...
                <div class="form-floating">
                <input name="surname" type="text" maxlength="45" placeholder="Фамилия" required  class="form-control" id="floatingInput">
                <label for="floatingInput">Фамилия</label>
                </div>

                <div class="form-floating">
                <input name="login" type="text" maxlength="45" placeholder="Логин" required  class="form-control" id="floatingInput">
